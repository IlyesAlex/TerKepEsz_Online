...
#preparing stimulus list
stim_table = pd.read_excel("stim_table_enc.xlsx")
...
#making evenly distributed list with 0-23 values, for choosing combinations from dict
random_combos = list(range(0,24))*11
r.shuffle(random_combos) #shuffle to randomize

#make new coordinates for each trials
for trial, random_combo in zip(stim_table.index, random_combos):
    #choosing a random combination of x and y coordinates
    combo = combo_dicts[random_combo]
    #making a Trial type object
    trial_curr = Trial(trial, combo)
...
#export to excel
stim_table.to_excel(r"stim_table_enc_new.xlsx", sheet_name='Stimuli')



>>>>>>> 1899b80ee2c2a0f33b0fd2e50eab5abacb65cf83
